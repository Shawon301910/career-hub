...
const Footer = () => {
    return (
        <div className="bg-base-200">
            <footer className="footer w-full lg:w-4/5 mx-auto p-10 text-base-content">
                <nav>
            ...
            <footer className="footer w-full lg:w-4/5 mx-auto px-10 py-4 border-t  text-base-content border-base-300">
